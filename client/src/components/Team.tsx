...
const Team = () => {
  ...
  const handleContactTeamMember = (memberName: string, email: string) => {
    ...
    window.open(
      `mailto:${email}?subject=Project Inquiry&body=${encodeURIComponent(message)}`,
      "_blank",
    );
  };
    ...
    <section className="py-24 bg-card" data-testid="team-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed"></p>
        </motion.div>
